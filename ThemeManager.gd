...
var all_decorations = {
	"Deco1": {"name": "coffee", "region": Rect2(1395, 416, 82, 95), "scale": 1.38},
	"Deco2": {"name": "plant", "region": Rect2(1144, 568, 166, 197), "scale": 0.58},
	"Deco3": {"name": "ballpen", "region": Rect2(1011, 568, 65, 150), "scale": 1.43},
	"Deco4": {"name": "notebook", "region": Rect2(1313, 568, 144, 126), "scale": 1.465},
	"Deco5": {"name": "lush1", "region": Rect2(1467, 518, 46, 43), "scale": 2.445},
	"Deco6": {"name": "lush2", "region": Rect2(1515, 518, 56, 55), "scale": 2.065},
	"Deco7": {"name": "wildflower", "region": Rect2(1573, 518, 57, 35), "scale": 2.87},
	"Deco8": {"name": "butterfly", "region": Rect2(1631, 518, 64, 31), "scale": 1.485},
	"Deco9": {"name": "feather", "region": Rect2(1539, 656, 43, 47), "scale": 2.445},
	"Deco10": {"name": "cloud", "region": Rect2(1465, 656, 66, 46), "scale": 2.71},
	"Deco11": {"name": "paper_plane", "region": Rect2(1589, 656, 48, 35), "scale": 2.92},
	"Deco12": {"name": "tea", "region": Rect2(1467, 580, 49, 49), "scale": 2.445},
	"Deco13": {"name": "bamboo", "region": Rect2(1519, 580, 33, 60), "scale": 2.71},
	"Deco14": {"name": "sakura_branch1", "region": Rect2(1561, 580, 57, 19), "scale": 2.87},
	"Deco15": {"name": "sakura_branch2", "region": Rect2(1561, 604, 51, 45), "scale": 2.92},
	"Deco16": {"name": "Cinnamon", "region": Rect2(0, 0, 64, 64), "scale": 1.0},
	"Deco17": {"name": "Gloves", "region": Rect2(64, 0, 64, 64), "scale": 1.0},
	"Deco18": {"name": "Berries", "region": Rect2(128, 0, 64, 64), "scale": 1.0},
	"Deco19": {"name": "Aster", "region": Rect2(0, 0, 64, 64), "scale": 1.0},
	"Deco20": {"name": "Pine", "region": Rect2(64, 0, 64, 64), "scale": 1.0},
	"Deco21": {"name": "Acorn", "region": Rect2(128, 0, 64, 64), "scale": 1.0}
}
